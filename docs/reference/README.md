...
| [Managing a Group](managing-a-group.md) | Privilege tiers, workspace manager actions, budgets and limits set by administrators, and the usage reports. |
| [Policy](policy.md) | Data classification, appropriate use, hosting of services, use of shared resources, self-supporting programs, and scheduled maintenance. |
| [Software](software.md) | R and RStudio, MATLAB and GNU Octave, Stata, licensed software, complex and experimental capabilities, and software installed without a ticket. |
